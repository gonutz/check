...
// Eps is the threshold that is used to compare float and complex values. They
// are considered equal if their absolute difference is less than or equal to
// this value. Set Eps = 0 to compare for exact equality.
var Eps = 1e-6
...
func deepValueEqual(v1, v2 reflect.Value, visited map[visit]bool, depth int) bool {
	...
	case reflect.Float32, reflect.Float64:
		...
		return (k2 == reflect.Float32 || k2 == reflect.Float64) &&
			floatEq(v1.Float(), v2.Float())
	case reflect.Complex64, reflect.Complex128:
		k2 := v2.Kind()
		return (k2 == reflect.Complex64 || k2 == reflect.Complex128) &&
			floatEq(real(v1.Complex()), real(v2.Complex())) &&
			floatEq(imag(v1.Complex()), imag(v2.Complex()))
	case reflect.String:
